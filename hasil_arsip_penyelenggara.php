...
<body>
    ...
    <div class="banner">
        ...
        <div class="content">
            ...
            <br>
            <a href="penyelenggara_admin.php">Unggah Dokumen Baru</a>
            <br><br>
            ...
            <table class="content-table">
                ...
                <tbody>
                    ...
                    // Jika query tidak mengembalikan hasil ($result->num_rows == 0), akan ditampilkan pesan "Tidak ada dokumen ditemukan."
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            |
                            <!-- Tombol Edit -->
                            <a href="edit_file.php?id=<?= $row['id']; ?>&redirect=hasil_arsip_penyelenggara.php">Edit</a>
                            |
                            <!-- Tombol Hapus -->
